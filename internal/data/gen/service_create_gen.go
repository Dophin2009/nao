...
//go:generate genny -in=service_create_gen.go -out=service_create.gen.go gen "EntityType=Media,Episode,Character,Genre,Producer,Person,MediaRelation,MediaCharacter,MediaGenre,MediaProducer,UserMedia,UserMediaList"
